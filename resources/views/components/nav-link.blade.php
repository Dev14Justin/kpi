...
? 'inline-flex items-center px-1 pt-1 border-b-2 border-accent text-sm font-bold leading-5 text-foreground focus:outline-none focus:border-accent transition duration-150 ease-in-out'
